...
.trafficlight{background:url(image.php?theme=formal_white&image=navflagged&rev=292&component=quiz) no-repeat top right}.path-mod-quiz .qnbutton.notyetanswered,
...
li{background-image:url(image.php?theme=formal_white&image=userplan%2Ftask-todo&rev=292&component=mod_workshop);background-position:top left;background-repeat:no-repeat;list-style-type:none}.path-mod-workshop .userplan tr.phasetasks
li.completed{background-image:url(image.php?theme=formal_white&image=userplan%2Ftask-done&rev=292&component=mod_workshop)}.path-mod-workshop .userplan tr.phasetasks
li.fail{background-image:url(image.php?theme=formal_white&image=userplan%2Ftask-fail&rev=292&component=mod_workshop)}.path-mod-workshop .userplan tr.phasetasks
li.info{background-image:url(image.php?theme=formal_white&image=userplan%2Ftask-info&rev=292&component=mod_workshop)}.path-mod-workshop .userplan tr.phasetasks
...
0 4px;padding:0px;width:100px;height:20px;position:relative;background:url(image.php?theme=formal_white&image=i%2Fstar-rating&rev=292) top left repeat-x;float:left}#page-blocks-community-communitycourse .star-rating
li{padding:0px;margin:0px;height:20px;width:20px;float:left}#page-blocks-community-communitycourse .star-rating li.current-rating{background:url(image.php?theme=formal_white&image=i%2Fstar-rating&rev=292) left bottom;position:absolute;height:20px;display:block;text-indent: -9000px;z-index:1}#page-blocks-community-communitycourse
...
.tree_item.branch{background-image:url(image.php?theme=formal_white&image=t%2Fexpanded&rev=292);background-position:0 10%;background-repeat:no-repeat}.block_navigation .block_tree
...
.tree_item.emptybranch{background-image:url(image.php?theme=formal_white&image=t%2Fcollapsed_empty&rev=292);background-position:0% 5%;background-repeat:no-repeat}.jsenabled .block_navigation .block_tree .collapsed
ul{display:none}.jsenabled .block_navigation .block_tree .collapsed
.tree_item.branch{background-image:url(image.php?theme=formal_white&image=t%2Fcollapsed&rev=292)}.jsenabled .block_navigation .block_tree
.tree_item.branch.loadingbranch{background-image:url(image.php?theme=formal_white&image=i%2Floading_small&rev=292)}.jsenabled .block_navigation.dock_on_load,
...
.tree_item.emptybranch{background-image:url(image.php?theme=formal_white&image=t%2Fcollapsed_empty_rtl&rev=292);background-position:center right}.jsenabled.dir-rtl .block_navigation .block_tree .collapsed
.tree_item.branch{background-image:url(image.php?theme=formal_white&image=t%2Fcollapsed_rtl&rev=292)}.block_online_users .content .list
...
.tree_item.branch{background-image:url(image.php?theme=formal_white&image=t%2Fexpanded&rev=292);background-position:0 10%;background-repeat:no-repeat}.block_settings .block_tree
.root_node.leaf{padding-left:0px}.block_settings .block_tree
.active_tree_node{font-weight:bold}.jsenabled .block_settings .block_tree
.tree_item.branch{cursor:pointer}.jsenabled .block_settings .block_tree
.tree_item.emptybranch{background-image:url(image.php?theme=formal_white&image=t%2Fcollapsed_empty&rev=292);background-position:0 10%;background-repeat:no-repeat}.jsenabled .block_settings .block_tree .collapsed
ul{display:none}.jsenabled .block_settings .block_tree .collapsed
.tree_item.branch{background-image:url(image.php?theme=formal_white&image=t%2Fcollapsed&rev=292)}.ie6 .block_settings .block_tree
...
.tree_item.emptybranch{background-image:url(image.php?theme=formal_white&image=t%2Fcollapsed_empty_rtl&rev=292);background-position:center right}.jsenabled.dir-rtl .block_settings .block_tree .collapsed
.tree_item.branch{background-image:url(image.php?theme=formal_white&image=t%2Fcollapsed_rtl&rev=292)}.block_tag_flickr .flickr-photos{padding:3px}.block_tag_youtube .youtube-thumb{padding:3px;padding-bottom:0.5em;display:block;float:left}.block_tag_youtube .yt-video-entry
...
input{width:20px;height:16px;background:transparent url(image.php?theme=formal_white&image=i%2Fcross_red_big&rev=292) no-repeat center top}.gradingform_rubric.editor .levels .level .delete
input{width:20px;height:16px;background:transparent url(image.php?theme=formal_white&image=i%2Fcross_red_small&rev=292) no-repeat center top}.gradingform_rubric.editor .moveup
input{width:20px;height:15px;background:transparent url(image.php?theme=formal_white&image=t%2Fup&rev=292) no-repeat center top;margin-top:4px}.gradingform_rubric.editor .movedown
input{width:20px;height:15px;background:transparent url(image.php?theme=formal_white&image=t%2Fdown&rev=292) no-repeat center top;margin-top:4px}.gradingform_rubric.editor .addcriterion input,
.gradingform_rubric.editor .addlevel
input{background:transparent url(image.php?theme=formal_white&image=t%2Faddgreen&rev=292) no-repeat;display:block;color:#555;font-weight:bold;text-decoration:none}.gradingform_rubric.editor .addcriterion
...
.ygtvtn{background:url(image.php?theme=formal_white&image=y%2Ftn&rev=292) 0 0 no-repeat;width:17px;height:22px}.file-picker
.ygtvtm{background:url(image.php?theme=formal_white&image=y%2Ftm&rev=292) 0 0 no-repeat;width:34px;height:22px;cursor:pointer}.file-picker
.ygtvtmh{background:url(image.php?theme=formal_white&image=y%2Ftmh&rev=292) 0 0 no-repeat;width:34px;height:22px;cursor:pointer}.file-picker
.ygtvtp{background:url(image.php?theme=formal_white&image=y%2Ftp&rev=292) 0 0 no-repeat;width:34px;height:22px;cursor:pointer}.file-picker
.ygtvtph{background:url(image.php?theme=formal_white&image=y%2Ftph&rev=292) 0 0 no-repeat;width:34px;height:22px;cursor:pointer}.file-picker
.ygtvln{background:url(image.php?theme=formal_white&image=y%2Fln&rev=292) 0 0 no-repeat;width:17px;height:22px}.file-picker
.ygtvlm{background:url(image.php?theme=formal_white&image=y%2Flm&rev=292) 0 0 no-repeat;width:34px;height:22px;cursor:pointer}.file-picker
.ygtvlmh{background:url(image.php?theme=formal_white&image=y%2Flmh&rev=292) 0 0 no-repeat;width:34px;height:22px;cursor:pointer}.file-picker
.ygtvlp{background:url(image.php?theme=formal_white&image=y%2Flp&rev=292) 0 0 no-repeat;width:34px;height:22px;cursor:pointer}.file-picker
.ygtvlph{background:url(image.php?theme=formal_white&image=y%2Flph&rev=292) 0 0 no-repeat;width:34px;height:22px;cursor:pointer}.file-picker
.ygtvloading{background:url(image.php?theme=formal_white&image=y%2Floading&rev=292) 0 0 no-repeat;width:16px;height:22px}.file-picker
.ygtvdepthcell{background:url(image.php?theme=formal_white&image=y%2Fvline&rev=292) 0 0 no-repeat;width:17px;height:22px}.file-picker
...
#custommenu .yui3-menu .yui3-menu .yui3-menu-label{background-image:url(image.php?theme=formal_white&image=vertical-menu-submenu-indicator&rev=292&component=theme)}#custommenu .yui3-menu .yui3-menu .yui3-menu-label-menuvisible{background-image:url(image.php?theme=formal_white&image=horizontal-menu-submenu-indicator&rev=292&component=theme)}.smartselect{position:absolute}.smartselect
...
.smartselect_submenuitem{background-image:url(image.php?theme=formal_white&image=t%2Fcollapsed&rev=292);background-repeat:no-repeat;background-position:100%}.smartselect.spanningmenu
...
.dir-rtl .ygtvcancel,
.dir-rtl .ygtvcancel:hover{width:18px;height:22px;background-image:url(image.php?theme=formal_white&image=yui2-treeview-sprite-rtl&rev=292&component=theme);background-repeat:no-repeat;cursor:pointer}.dir-rtl
...
.ajaxworking{position:absolute;top:0;left:20px;width:20px;height:20px;background:url(image.php?theme=formal_white&image=i%2Fajaxloader&rev=292) no-repeat}.dir-rtl.path-course-view
...
div{display:inline;cursor:pointer}.course_category_tree .category.with_children>.category_label{background-image:url(image.php?theme=formal_white&image=t%2Fexpanded&rev=292);background-repeat:no-repeat}.course_category_tree
...
.course_link{display:block;background-image:url(image.php?theme=formal_white&image=i%2Fcourse&rev=292);background-repeat:no-repeat;padding-left:18px}.course_category_tree .category
...
.category_label{background-image:url(image.php?theme=formal_white&image=t%2Fcollapsed&rev=292)}.jsenabled .course_category_tree .category.with_children.collapsed .subcategories,
...
.category_label{background-image:url(image.php?theme=formal_white&image=t%2Fcollapsed_rtl&rev=292)}.dir-rtl .course_category_tree .category .courses
...
17px 0 17px;float:none}#frametop,#footerframetop{background-image:url(image.php?theme=formal_white&image=roundcorner%2Fheader&rev=292&component=theme);margin:15px
15px 0;background-position:0 0;background-repeat:repeat-x;min-width:934px}#frametopright,#footerframetopright{background-image:url(image.php?theme=formal_white&image=roundcorner%2Fheader_r&rev=292&component=theme);background-repeat:no-repeat;background-position:100% 0;text-align:left;height:17px;margin:0
0 0 17px}#frametopright div,
#footerframetopright
div{background-image:url(image.php?theme=formal_white&image=roundcorner%2Fheader_l&rev=292&component=theme);font-size:1px;line-height:1%;height:17px;background-repeat:no-repeat;background-position:0 0;background-color:transparent;position:relative;width:17px;margin-left:-17px}#frameleft,#footerframeleft{background-image:url(image.php?theme=formal_white&image=roundcorner%2Fbody_l&rev=292&component=theme);background-repeat:repeat-y;background-position:0 0;background-color:#FFF}#frameright,#footerframeright{background-image:url(image.php?theme=formal_white&image=roundcorner%2Fbody_r&rev=292&component=theme);background-repeat:repeat-y;background-position:100% 0;background-color:transparent}#framebottomright,#footerframebottomright{background-image:url(image.php?theme=formal_white&image=roundcorner%2Ffooter_r&rev=292&component=theme);background-repeat:no-repeat;background-position:100% 0;text-align:left;margin:0
0 0 17px}#framebottomright div,
#footerframebottomright
div{background-image:url(image.php?theme=formal_white&image=roundcorner%2Ffooter_l&rev=292&component=theme);font-size:1px;line-height:1%;height:17px;background-repeat:no-repeat;background-position:0 0;background-color:transparent;position:relative;width:17px;margin-left:-17px}#framebottom,#footerframebottom{background-image:url(image.php?theme=formal_white&image=roundcorner%2Ffooter&rev=292&component=theme);background-repeat:repeat-x;background-position:0 100%;background-attachment:scroll;background-color:transparent}#footerwrapper{background-color:white;margin:0
17px 0 17px}#footerframetop{margin-top:0}#footerwrapper p,
#footerwrapper
div{margin:0}div.yui3-menu-content{border:none !important}#custommenu .yui3-menu{background-image:url(image.php?theme=formal_white&image=custommenubg&rev=292&component=theme);background-repeat:repeat-x;background-color:#e1e1df}.yui3-skin-sam #page .yui3-menu-horizontal .yui3-menu-content{background-position: -10000px -10000px}.yui3-skin-sam #page .yui3-menu-horizontal .yui3-menu-label{background-position: -10000px -10000px}.yui3-skin-sam #page .yui3-menu-horizontal .yui3-menu-label-active,
...
0}.course-content
.header{background-image:url(image.php?theme=formal_white&image=gradient_h&rev=292&component=theme);background-repeat:repeat-x;border-top:1px #C6BDA8 solid;background-color:#E3DFD4}.course-content
...
.category{background-color:#FFF;background-image:url(image.php?theme=formal_white&image=hgradient&rev=292&component=theme);background-repeat:repeat-x;border:1px
...
.path-calendar .minicalendar
th{background:url(image.php?theme=formal_white&image=gradient-sb&rev=292&component=theme) repeat-x 0 0}.calendartable th,
.calendartable
td{border:1px
...
a{background-image:url(image.php?theme=formal_white&image=tab%2Fleft&rev=292&component=theme);padding-left:14px;padding-top:10px;background-repeat:no-repeat;padding-bottom:4px;margin-bottom:-1px;background-color:transparent;border:none}.tabtree .tabrow0 li a:hover{background-image:url(image.php?theme=formal_white&image=tab%2Fleft_hover&rev=292&component=theme)}.tabtree .tabrow0 li a
span{background-image:url(image.php?theme=formal_white&image=tab%2Fright&rev=292&component=theme);background-repeat:no-repeat;background-position:100% 0%;padding-right:14px;padding-top:10px;padding-bottom:4px}.tabtree .tabrow0 li a:hover
span{background-image:url(image.php?theme=formal_white&image=tab%2Fright_hover&rev=292&component=theme)}.tabtree .tabrow0 ul,
.tabtree .tabrow0
div{background-image:url(image.php?theme=formal_white&image=tab%2Ftabrow1&rev=292&component=theme);background-position:0% 50%;position:absolute;width:100%;border-top:1px solid #aaa;padding:0.25em 0px;top:100%;margin:0px}.tabtree .tabrow0
...
h2{background-image:url(image.php?theme=formal_white&image=gradient_h&rev=292&component=theme);background-repeat:repeat-x;border-top:1px #C6BDA8 solid;background-color:#E3DFD4;border-top:1px #C6BDA8 solid}#page-mod-quiz-edit .questionbankwindow
...
.dockeditempanel_hd{background-image:url(image.php?theme=formal_white&image=gradient_h&rev=292&component=theme);background-repeat:repeat-x;text-align:left;height:1.8em;background-color:#E3DFD4}#dock #dockeditempanel .dockeditempanel_hd
h2{display:block;padding-left:0.3em;margin-top:0;text-align:left}#dock #dockeditempanel .dockeditempanel_hd
.commands{position:absolute;right:0.3em;top:0.25em}.navbar{width:auto;padding-top:0.35em;padding-bottom:0.15em;background-image:url(image.php?theme=formal_white&image=bg_bread&rev=292&component=theme);background-color:#AB9D80}.navbar li
...
.generalbox th,
.generaltable
th.header{background-image:url(image.php?theme=formal_white&image=gradient_h&rev=292&component=theme);background-repeat:repeat-x;border-top:1px #C6BDA8 solid;background-color:#E3DFD4}table.flexible .r0, table.generaltable
...
tr.rolecapheading{background-image:url(image.php?theme=formal_white&image=gradient_h&rev=292&component=theme);background-repeat:repeat-x;background-color:#E3DFD4}tr.rolecap{border-top:1px #F30 dashed}tr.rolecapheading+tr.rolecap{border-top:none}#page-admin-course-index .editcourse td
...
.title{background-image:url(image.php?theme=formal_white&image=gradient_h&rev=292&component=theme);background-repeat:repeat-x;clear:both;line-height:2em;background-color:#E3DFD4}.block .header .title
...
#listfields
.highlight{background:none repeat scroll 0 0 #E3DFD4}.capdefault{background-image:url(image.php?theme=formal_white&image=gradient_h&rev=292&component=theme);background-repeat:repeat-x;background-color:#E3DFD4}table#defineroletable
